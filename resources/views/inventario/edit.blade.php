            ...
            <div class="card">
                ...
                <form action="{{route('inventario.update',$inventario->inv_id)}}" method="POST" onsubmit="return validar()">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="inv_cantidad" name="inv_cantidad" type="number" value="{{$inventario->inv_cantidad}}" name="inv_cantidad" type="number"  class="form-control @error('inv_cantidad') is-invalid @enderror" name="inv_cantidad" value="{{ old('inv_cantidad') }}" required autocomplete="inv_cantidad">
                            @error('inv_cantidad')
